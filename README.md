...
**2단계.** Claude Desktop → **Settings → Developer** → `pr-review-agent.dxt` 드래그앤드롭

**3단계.** Claude Desktop 재시작 후, 리뷰하려는 프로젝트 경로를 함께 알려주면 됩니다:

> "C:/Users/me/my-project 기준으로 main 대비 리뷰해줘"
> "D:/work/backend — main과 HEAD 사이 DocCheck 결과 보여줘"
...
프로젝트 경로 없이 현재 디렉토리 기준으로 바로 실행됩니다.
